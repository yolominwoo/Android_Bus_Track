...
public class RouteActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {

    TextView bus1711, bus01;

    SwipeRefreshLayout swipeRefreshLayout;
    String key ="QWI%2BIX9Zr4CUcS85K2bULpsff1B4B9t15pBOV6Z%2FRSurR1nqp4wAL%2F6pVUN3STofXK1qx2Vrie7BMSwm%2Fmx0fw%3D%3D";
    String data1711, data01;

    @Override
    protected void onCreate(Bundle savedInstanceState) {

        super.onCreate(savedInstanceState);
        setContentView(R.layout.route_transit);

        bus1711 = (TextView)findViewById(R.id.show1711Info);
        ...
        // 안내시작 버튼 클릭
        Button start_guide= (Button) findViewById(R.id.start_guide);
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                data1711 = get1711Data();
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        bus1711.setText(data1711);
                    }
                });
            }
        }).start();
